...
grouped$difficulty_level<-c("very streneous", "easiest","moderate","very streneous","moderate","very streneous")
...
difficulty_map <- leaflet() %>%
  addTiles() %>%
  addPolylines(data = hiking_trails, color = "~pal(c(3, 2, 5, 1, 5, 2))")%>%
